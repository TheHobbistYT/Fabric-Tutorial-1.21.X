package net.thehobbistyt.tutorialmod.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.thehobbistyt.tutorialmod.TutorialMod;
import net.thehobbistyt.tutorialmod.block.custom.MagicBlock;
...
import net.thehobbistyt.tutorialmod.block.custom.PinkGarnetLampBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_LAMP = registerBlock("pink_garnet_lamp",
            new PinkGarnetLampBlock(AbstractBlock.Settings.create()
                    .strength(1).requiresTool().luminance(state -> state.get(PinkGarnetLampBlock.CLICKED) ? 15 : 0)));
